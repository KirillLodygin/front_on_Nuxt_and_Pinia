<template>
  ...
  <div v-else class="h-100">
    <TableBlockWrapper
      :navigate-string="navigateString.research"
      :page-header="pageHeader.research"
      :title-for-add-button="titleForAddButton.research"
    />
  </div>
</template>
...
import TableBlockWrapper from '~/components/ObjectsTable/TableBlockWrapper.vue'
